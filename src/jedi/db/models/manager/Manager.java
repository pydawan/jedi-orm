...
package jedi.db.models.manager;
            ...
            while (resultSet.next()) {
                ...
                for (Field field : entity.getDeclaredFields()) {
                    ...
                    if (manyToManyFieldAnnotation != null) {
                        ...
                        String intermediateModelName = manyToManyFieldAnnotation.through();
                    ...
                    } else if (foreignKeyFieldAnnotation != null || oneToOneFieldAnnotation != null) {
                ...
                while (resultSet.next()) {
                    ...
                    for (Field field : entity.getDeclaredFields()) {
                        ...
                        if (manyToManyFieldAnnotation != null) {
                            ...
                            args = args.replace("=", "");
                            args = args.replace(", ", ",");
                            args = args.replace(String.format("%s_id", getColumnName(model)), "");
                            ...
                            Model associatedModel = manager.get(
                        		"id", 
                        		resultSet.getObject(String.format("%s_id", getColumnName(field.getType())))
                    		);
                            ...
                            if ((field.getType().getSimpleName().equals("int") || 
                                ...
                                if (resultSet.getObject(getColumnName(field.getName())) == null) {
                                    ...
                                    field.set(obj, ((java.math.BigDecimal) resultSet.getObject(getColumnName(field.getName()))).intValue());
                                }
                            } else {
                        ...
                        if (manyToManyFieldAnnotation != null) {
                            ...
                            if ((field.getType().getSimpleName().equals("int") || 
                                ...
                                if (resultSet.getObject(TableUtil.getColumnName(field)) == null) {
                                    ...
                                    field.set(
                                		obj, 
                                		((java.math.BigDecimal) resultSet.getObject(TableUtil.getColumnName(field))).intValue()
                            		);
                                }
                            } else {
                                field.set(obj, resultSet.getObject(TableUtil.getColumnName(field)));
                            }
                        }
                    }
                    T model = (T) obj;
            ...
            for (Field field : this.entity.getDeclaredFields()) {
                ...
                if (foreignKeyFieldAnnotation != null) {
                	...
                	if (model.equals(associatedModelClass.getSimpleName())) {
	                    querySet = this.filter(String.format("%s_id=%d", associatedModelClass.getSimpleName().toLowerCase(), id));
                	}
                }
            }
            if (querySet == null) {
