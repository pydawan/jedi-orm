...
public class PyFile extends java.io.RandomAccessFile {
	
	private java.lang.String mode;

	public PyFile(java.lang.String name, java.lang.String mode) throws FileNotFoundException {
		...
		try {
			...
			if (mode.equals("a") ) {
				// Salta os bytes já existentes no arquivo para que o novo conteúdo seja incluido no fim.
	...
	public PyFile(java.lang.String name) throws FileNotFoundException {
		super(name, "r");
	}
	...
	public void write(java.lang.String format, Object ... objects) {
		...
		if (objects != null) {
			// Verificando se existe um formato e se o mesmo não é uma string vazia.
